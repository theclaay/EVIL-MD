...
smd({
  ...
  try {
    let _0x365550 = "┏━━━━━━━━━━━━━━━━━━━━━━━━\n┃\t*𝐄𝐕𝐈𝐋-𝐌𝐃-𝐅𝐀𝐍𝐂𝐘-𝐓𝐄𝐗𝐓✍️* \n┗━━━━━━━━━━━━━━━━━━━━━━━━\n\n " + (_0x3b568a ? "```🔢Reply the number you wants to select``` \n\n" : "```\t\t" + prefix + "fancy Evil(For all text)\n\t\t" + prefix + "fancy 25 EVIL(For specific text)```\n\n");
    let _0x50c7d9 = parseInt(_0x3b568a);
    if (isNaN(_0x50c7d9)) {
      let _0x4ca942 = _0x3b568a ? _0x3b568a : "Evil";
...
smd({
  ...
  try {
    ...
    if (!_0xd51ec) {
      return _0x4cfc4e.reply("*_Example : " + prefix + "fliptext EVIL-MD!_*");
    }
...
smd({
  ...
  try {
    ...
    if (_0x2cee76) {
      ...
      return _0x54e3dc.reply("*_Hey, provide text, ex .ttp 4 hii im Evil!!_*");
    }
  } catch (_0x72e5d) {
