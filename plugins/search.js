...
smd({
        ...
        }catch(e){return await message.error(`${e}\n\n command: ${cmdName}`,e,`*_Heyy dear, Didn't get any results!_*`) }
        }
    )
    //---------------------------------------------------------------------------
smd({
...
smd({
        ...
        async(message, text) => {            
            ...
            }catch(e){return await message.error(`${e}\n\n command: horo`,e,`*_Heyy dear, Didn't get any results!_*`) }
        }
    )
...
}catch(e){return await message.error(`${e}\n\n command: cric`,e,`*_Heyy dear, Didn't get any results!_*`) }
...
smd({
        ...
        async(message, text) => {
          ...
          }catch(e){return await message.error(`${e}\n\n command: google`,e,`*_Heyy dear, Didn't get any results!_*`) }
...
}catch(e){return await message.error(`${e}\n\n command: image`,e,`*_Heyy dear, Didn't get any results!_*`) }
 })
    //---------------------------------------------------------------------------
smd({
            pattern: "couplepp",
        ...
        async(message) => {
          ...
          }catch(e){return await message.error(`${e}\n\n command: couplepp`,e,`*_Heyy dear, Didn't get any results!_*`) }
        }
