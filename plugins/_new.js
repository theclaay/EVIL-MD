...
smd(
  {
    pattern: "wagroup",
    desc: "TO GET SUPPORT NUMBER OF EVIL",
    react: "🗨️",
    category: "user",
    filename: __filename,
  },
  async (message) => {
    const SupportMsg = `EVIL-MD WHATSAPP GROUP\n\n *LINK:*https://chat.whatsapp.com/JvaJHe9m6N6CMWqTRSAcbp \n\n ${Config.botname} *WORKS*`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*HEY EVIL IS CURRENTLY ACTIVE! 🤖*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x11eeb1) {
       return await _0x7587f6.reply("_Need fileName, Example: document Evil | caption_");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://Mrunknown54/EVIL-MD*");
     }
 ...
 let tmpUrl = "https://telegra.ph/file/1271d54767e6d0c21855a.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
