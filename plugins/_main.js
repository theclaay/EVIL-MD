...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Ask me any question, for example, How can I become a programmer, tell me tips and tricks, and also give me full RoadMap and follow Evil");
    }
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/repos/Mrunknown54/EVIL-MD");
    let _0x1c73f9 = ("\nᴇᴠɪʟ ᴍᴅ ɪs ᴀ ᴄᴏᴏʟ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ  ᴍᴀᴅᴇ ʙʏ *" + Config.ownername + "*.\n\n  *❒Stars:* " + (_0x44f98c?.stargazers_count || "Unkown") + " stars\n  *❒Forks:* " + (_0x44f98c?.forks_count || "Unkown") + " forks\n  *❒Authors:* ᴇᴠɪʟ ᴍᴅ\n  *❒Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❒Repo:* _https://github.com/Mrunknown54/EVIL-MD_\n  *❒Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*ᴇᴠɪʟ-ᴍᴅ• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("ᴇᴠɪʟ-ᴍᴅ• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("ᴇᴠɪʟ-ᴍᴅ• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
